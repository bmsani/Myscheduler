      ...
      {user ? 
        ...
        <div className="flex-none">
          <ul className="menu menu-horizontal p-0">
            ...
            <li><Link to='/'>Availability</Link></li>
            <li>
              <div className="w-16 rounded-full ">
                <img src={user.photoURL|| "https://findicons.com/files/icons/1024/dress_it_profession/128/assassin_avatar.png" as string} className='rounded-full border-2 border-secondary' alt=""/>
              </div>
            </li>
            <li tabIndex={0}>
              <Link to='/home'>
