...
const Footer = () => {
  return (
    <div>
      <footer className="footer mx-auto max-w-[1400px] bg-secondary">
        <div className="grid-flow-row grid-cols-1 md:grid-cols-2 lg:grid-cols-5 p-5 md:p-10  text-neutral-content">
          <div className="col-span-2 md:order-3 lg:order-1 pl-4">
            <span className="flex">
              <img className="pr-5" src={location} alt="" /> H#000 (0th Floor),
              Road #000{" "}
            </span>
            <p className="pl-10">
              9 Bir Uttam A.K Khandaker Sarak, Mohakhali C/A, Dhaka
            </p>
          </div>
          ...
          <div className="col-span-1 md:order-4 pl-4">
            ...
            <p>
              We're committed to keeping our customer service human. There’s
              incredible power in human connection; AI simply can't beat it!
            </p>
