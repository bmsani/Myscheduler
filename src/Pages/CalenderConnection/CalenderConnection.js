            ...
            <div className='shadow border container mx-auto pb-5 mt-8'>
                ...
                <div className=''>
                    <div className='flex justify-between border-t border-b px-8 py-8 bg-gray-50'>
                        ...
                        <div>
                            <button className='text-secondary text-sm hover:text-red-500 hover:underline underline-offset-1'>Disconnect</button>
                        </div>
                    ...
                    <div className='grid lg:grid-cols-2 sm:grid-cols-1 '>
                        <div className='flex '>
                            ...
                            <div className='ml-4'>
                                ...
                                <h2 className='text-light text-xs'>Set the calendar(s) to check for conflicts to prevent double bookings.
                                </h2>
                            </div>
                        </div>
                        <div className='flex justify-between border hover:border-blue-800 p-4'>
                            <div className='flex '>
                                <div class="avatar">
                                    <div class="w-11 p-3 shadow border rounded-full">
                                        <img src={calender} alt='' />
                                    </div>
                                </div>
