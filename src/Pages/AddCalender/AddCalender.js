...
import logo from '../../Utilities/icon/calender_icon.png'
        ...
        <div>
            <div className='shadow border container mx-auto pb-5 mt-6'>
                <div className='py-4 px-8'>
                    ...
                    <h2 className='text-light text-sm'>Connect your calendar to let Calendly know when you're available and update your calendar as events are scheduled.</h2>
                </div>
                ...
                <div className='flex justify-between mx-8 items-center py-3'>
                    <div className='flex items-center '>
                        <div class="avatar">
                            <div class="w-14 p-3 shadow rounded-full border">
                    ...
                    <div>
                        <button className='text-sm px-8  rounded-lg btn btn-sm btn-outline btn-info'>Connect</button>
                    </div>
                </div>
            </div>
        </div>
