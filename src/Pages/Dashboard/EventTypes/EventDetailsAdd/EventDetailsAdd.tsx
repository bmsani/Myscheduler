      ...
      <div className="xl:mx-48 sm:mx-8 border-2 border-zinc-500 mt-2 mb-8 pb-4">
        ...
        <div className="mx-8 mb-6 ">
          <div className="grid grid-cols-2 border-b pb-6">
            <div>
              ...
              <h2 className="text-sm my-4 font-bold">
              ...
              <div className="flex items-center gap-4">
                ...
                <input
                  ...
                  className="input w-[70px] max-w-xs block input-bordered"
                />
            ...
            <div>
              <h2 className="text-l font-light ml-4 mt-8">
          ...
          <div className="grid grid-cols-2 mt-6 mb-10">
            <div className="">
              ...
              <button className="border p-3 mr-3 hover:border-2 hover:border-blue-500  ">
          ...
          <div className="grid grid-cols-2">
            ...
            <div>
              <h2 className="text-l font-light">
                Give yourself some buffer time to prepare for or wrap up from
                booked Calendly events.
              </h2>
            </div>
          </div>
        ...
        <div className="border-t mx-10 py-4  grid place-items-end">
          <div>
            ...
            <button className="px-4 py-1 rounded-full text-white bg-blue-600">
              Next
            </button>
          </div>
        </div>
