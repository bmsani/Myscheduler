...
const Login: React.FC = () => {
  ...
  return (
    <div className="mx-auto px-2 md:px-5 lg:px-20 max-w-[1400px] grid grid-cols-1 md:grid-cols-2 items-center content-center py-12">
        ...
        <div className="w-[400px] p-5 border border-secondary rounded-lg shadow-sm shadow-secondary">
          <div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="form-control">
              ...
              <input
                type="submit"
                className="rounded-full text-white hover:bg-primary bg-secondary shadow-lg  duration-300 cursor-pointer mt-6 p-2 text-1xl"
                value="Login"
              />
            </form>
