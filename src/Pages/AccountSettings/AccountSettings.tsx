...
const AccountSettings: any = () => {
  ...
  return (
    <div className="mx-auto px-2 md:px-5 lg:px-20 max-w-[1400px] pt-6">
      <h2 className="text-2xl text-center font-semibold text-gray-600 pb-2">
        Account Settings
      </h2>
      <div className="drawer">
        <input id="my-drawer-3" type="checkbox" className="drawer-toggle" />
        <div className="drawer-content flex flex-col px-2 md:px-8 w-full lg:w-1/2 mx-auto rounded-lg">
