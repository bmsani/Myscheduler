...
const Steps = () => {
  return (
    <div className="pb-16">
      <h2 className="text-primary text-5xl font-bold w-[750px] text-center mx-auto pb-16">
        We make it easy to get started
      </h2>
      <ul className="steps steps-vertical lg:steps-horizontal w-full">
        <li className="step step-neutral">
          <div className="card w-96 text-neutral border shadow-lg">
        ...
        <li className="step step-neutral">
          <div className="card w-96 h-full text-neutral border shadow-lg">
            <div className="card-body items-center text-center">
