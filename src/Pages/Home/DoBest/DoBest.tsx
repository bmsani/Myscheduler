            ...
            <div className='text mt-20'>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 justify-center items-center my-20">
                    <div className='text-left'>
                        <h6 className='text-2xl text-accent font-semibold'>WORKFLOW MANAGEMENT</h6>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 justify-center items-center my-20">
                    ...
                    <div className='text-left'>
                        <h6 className='text-2xl text-secondary font-semibold'>ON-DEMAND SCHEDULING</h6>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 justify-center items-center my-20">
                    <div className='text-left'>
                        <h6 className='text-2xl text-secondary font-semibold'>THE COURTEOUS APPROACH</h6>
