...
const DoBest = () => {
    return (
        <div className='container mx-auto text-center my-20'>
            <div>
                <h2 className='text-5xl font-bold'>Do more of what you do best</h2>
                <p className='text-2xl'>With scheduling hassles and interruptions gone, your day is cleared for accomplishment.</p>
            </div>
